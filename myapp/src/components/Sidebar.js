...
<nav
  id="sidenav-8"
  class="  left-0  w-60 -translate-x-full overflow-y-auto h-screen sticky top-0 shadow-[0_4px_12px_0_rgba(0,0,0,0.07),_0_2px_4px_rgba(0,0,0,0.05)] data-[te-sidenav-hidden='false']:translate-x-0  bg-black"
    ...
    <li class="relative pt-4">
     <div className='flex  bg-gray-400'>
      ...
      <a
        ...
        data-te-sidenav-link-ref>
     <span>
            <div className="avatar flex items-center space-x-5">
<img class=" space-x-6 flex h-8 w-8 rounded-full" src="https://images.unsplash.com/photo-1568602471122-7832951cc4c5?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=facearea&facepad=2&w=300&h=300&q=80" alt="Image Description"/>
            <div className=''>Code with Harry </div>
            </div> 
             </span>
      </a>
    </li>
...
<img class=" space-x-6 flex h-8 w-8 rounded-full" src="https://images.unsplash.com/photo-1568602471122-7832951cc4c5?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=facearea&facepad=2&w=300&h=300&q=80" alt="Image Description"/>
    ...
    <div className='flex  my-2  bg-gray-400'>
        <hr></hr>
     </div>
    <li class="relative pt-4">
      <span
